...
export const ToggleButtons = ({ onButtonStateChange }) => {
  // Create a mapping between button names and background colors
  const buttonColors = {
    BlueBin: 'bg-0021f5',
    YellowBin: 'bg-ffc82f',
    GreenBin: 'bg-00ab15',
  ...
  // Create a state object to track the toggle state of each button
  ...
  useEffect(() => {
    // Pass the updated buttonStates back to the parent component whenever buttonStates changes
